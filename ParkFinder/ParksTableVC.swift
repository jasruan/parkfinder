...
//  ParkFinder
//
//  Created by Jasmine Ruan (RIT Student) on 3/31/17.
...
class ParksTableVC: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        //let park2 = StatePark(name: "Hamlin Beach State Park", latitude: 43.36139, longitude: -77.95861)
        parks = ParkData.shareData.parks
    }
    ...
    // MARK: -Delegate Methods- Table view data source
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let indexPath = tableView.indexPathForSelectedRow{
            ...
            guard selectedRow < ParkData.shareData.parks.count else{
                print("row\(selectedRow) is not in parks!)")
                return
            }
            let detailVC = segue.destination as! ParkDetailTableVC
            detailVC.park = ParkData.shareData.parks[selectedRow]
        }
    }
